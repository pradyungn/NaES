...
module nios_mm_interconnect_0 (
		...
		output wire [1:0]  ext_pll_pll_slave_address,                      //                        ext_pll_pll_slave.address
		output wire        ext_pll_pll_slave_write,                        //                                         .write
		output wire        ext_pll_pll_slave_read,                         //                                         .read
		input  wire [31:0] ext_pll_pll_slave_readdata,                     //                                         .readdata
		output wire [31:0] ext_pll_pll_slave_writedata,                    //                                         .writedata
	...
	wire   [31:0] ext_pll_pll_slave_agent_m0_readdata;                                                // ext_pll_pll_slave_translator:uav_readdata -> ext_pll_pll_slave_agent:m0_readdata
	wire          ext_pll_pll_slave_agent_m0_waitrequest;                                             // ext_pll_pll_slave_translator:uav_waitrequest -> ext_pll_pll_slave_agent:m0_waitrequest
	wire          ext_pll_pll_slave_agent_m0_debugaccess;                                             // ext_pll_pll_slave_agent:m0_debugaccess -> ext_pll_pll_slave_translator:uav_debugaccess
	wire   [27:0] ext_pll_pll_slave_agent_m0_address;                                                 // ext_pll_pll_slave_agent:m0_address -> ext_pll_pll_slave_translator:uav_address
	wire    [3:0] ext_pll_pll_slave_agent_m0_byteenable;                                              // ext_pll_pll_slave_agent:m0_byteenable -> ext_pll_pll_slave_translator:uav_byteenable
	wire          ext_pll_pll_slave_agent_m0_read;                                                    // ext_pll_pll_slave_agent:m0_read -> ext_pll_pll_slave_translator:uav_read
	wire          ext_pll_pll_slave_agent_m0_readdatavalid;                                           // ext_pll_pll_slave_translator:uav_readdatavalid -> ext_pll_pll_slave_agent:m0_readdatavalid
	wire          ext_pll_pll_slave_agent_m0_lock;                                                    // ext_pll_pll_slave_agent:m0_lock -> ext_pll_pll_slave_translator:uav_lock
	wire   [31:0] ext_pll_pll_slave_agent_m0_writedata;                                               // ext_pll_pll_slave_agent:m0_writedata -> ext_pll_pll_slave_translator:uav_writedata
	wire          ext_pll_pll_slave_agent_m0_write;                                                   // ext_pll_pll_slave_agent:m0_write -> ext_pll_pll_slave_translator:uav_write
	wire    [2:0] ext_pll_pll_slave_agent_m0_burstcount;                                              // ext_pll_pll_slave_agent:m0_burstcount -> ext_pll_pll_slave_translator:uav_burstcount
	wire          ext_pll_pll_slave_agent_rf_source_valid;                                            // ext_pll_pll_slave_agent:rf_source_valid -> ext_pll_pll_slave_agent_rsp_fifo:in_valid
	wire  [108:0] ext_pll_pll_slave_agent_rf_source_data;                                             // ext_pll_pll_slave_agent:rf_source_data -> ext_pll_pll_slave_agent_rsp_fifo:in_data
	wire          ext_pll_pll_slave_agent_rf_source_ready;                                            // ext_pll_pll_slave_agent_rsp_fifo:in_ready -> ext_pll_pll_slave_agent:rf_source_ready
	wire          ext_pll_pll_slave_agent_rf_source_startofpacket;                                    // ext_pll_pll_slave_agent:rf_source_startofpacket -> ext_pll_pll_slave_agent_rsp_fifo:in_startofpacket
	wire          ext_pll_pll_slave_agent_rf_source_endofpacket;                                      // ext_pll_pll_slave_agent:rf_source_endofpacket -> ext_pll_pll_slave_agent_rsp_fifo:in_endofpacket
	wire          ext_pll_pll_slave_agent_rsp_fifo_out_valid;                                         // ext_pll_pll_slave_agent_rsp_fifo:out_valid -> ext_pll_pll_slave_agent:rf_sink_valid
	wire  [108:0] ext_pll_pll_slave_agent_rsp_fifo_out_data;                                          // ext_pll_pll_slave_agent_rsp_fifo:out_data -> ext_pll_pll_slave_agent:rf_sink_data
	wire          ext_pll_pll_slave_agent_rsp_fifo_out_ready;                                         // ext_pll_pll_slave_agent:rf_sink_ready -> ext_pll_pll_slave_agent_rsp_fifo:out_ready
	wire          ext_pll_pll_slave_agent_rsp_fifo_out_startofpacket;                                 // ext_pll_pll_slave_agent_rsp_fifo:out_startofpacket -> ext_pll_pll_slave_agent:rf_sink_startofpacket
	wire          ext_pll_pll_slave_agent_rsp_fifo_out_endofpacket;                                   // ext_pll_pll_slave_agent_rsp_fifo:out_endofpacket -> ext_pll_pll_slave_agent:rf_sink_endofpacket
	wire          cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> ext_pll_pll_slave_agent:cp_valid
	wire  [107:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> ext_pll_pll_slave_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                              // ext_pll_pll_slave_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [16:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> ext_pll_pll_slave_agent:cp_channel
	wire          cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> ext_pll_pll_slave_agent:cp_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> ext_pll_pll_slave_agent:cp_endofpacket
	...
	wire  [107:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> leds_pio_s1_agent:cp_data
	...
	wire   [27:0] hex_pio_s1_agent_m0_address;                                                        // hex_pio_s1_agent:m0_address -> hex_pio_s1_translator:uav_address
	...
	wire  [108:0] hex_pio_s1_agent_rf_source_data;                                                    // hex_pio_s1_agent:rf_source_data -> hex_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [108:0] hex_pio_s1_agent_rsp_fifo_out_data;                                                 // hex_pio_s1_agent_rsp_fifo:out_data -> hex_pio_s1_agent:rf_sink_data
	...
	wire          cmd_mux_015_src_valid;                                                              // cmd_mux_015:src_valid -> hex_pio_s1_agent:cp_valid
	wire  [107:0] cmd_mux_015_src_data;                                                               // cmd_mux_015:src_data -> hex_pio_s1_agent:cp_data
	wire          cmd_mux_015_src_ready;                                                              // hex_pio_s1_agent:cp_ready -> cmd_mux_015:src_ready
	wire   [16:0] cmd_mux_015_src_channel;                                                            // cmd_mux_015:src_channel -> hex_pio_s1_agent:cp_channel
	wire          cmd_mux_015_src_startofpacket;                                                      // cmd_mux_015:src_startofpacket -> hex_pio_s1_agent:cp_startofpacket
	wire          cmd_mux_015_src_endofpacket;                                                        // cmd_mux_015:src_endofpacket -> hex_pio_s1_agent:cp_endofpacket
	...
	wire          ext_pll_pll_slave_agent_rp_valid;                                                   // ext_pll_pll_slave_agent:rp_valid -> router_006:sink_valid
	wire  [107:0] ext_pll_pll_slave_agent_rp_data;                                                    // ext_pll_pll_slave_agent:rp_data -> router_006:sink_data
	wire          ext_pll_pll_slave_agent_rp_ready;                                                   // router_006:sink_ready -> ext_pll_pll_slave_agent:rp_ready
	wire          ext_pll_pll_slave_agent_rp_startofpacket;                                           // ext_pll_pll_slave_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          ext_pll_pll_slave_agent_rp_endofpacket;                                             // ext_pll_pll_slave_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [107:0] leds_pio_s1_agent_rp_data;                                                          // leds_pio_s1_agent:rp_data -> router_008:sink_data
	...
	wire          hex_pio_s1_agent_rp_valid;                                                          // hex_pio_s1_agent:rp_valid -> router_017:sink_valid
	wire  [107:0] hex_pio_s1_agent_rp_data;                                                           // hex_pio_s1_agent:rp_data -> router_017:sink_data
	wire          hex_pio_s1_agent_rp_ready;                                                          // router_017:sink_ready -> hex_pio_s1_agent:rp_ready
	wire          hex_pio_s1_agent_rp_startofpacket;                                                  // hex_pio_s1_agent:rp_startofpacket -> router_017:sink_startofpacket
	wire          hex_pio_s1_agent_rp_endofpacket;                                                    // hex_pio_s1_agent:rp_endofpacket -> router_017:sink_endofpacket
	...
	wire          ext_pll_pll_slave_agent_rdata_fifo_src_valid;                                       // ext_pll_pll_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] ext_pll_pll_slave_agent_rdata_fifo_src_data;                                        // ext_pll_pll_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          ext_pll_pll_slave_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_004:in_0_ready -> ext_pll_pll_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> ext_pll_pll_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> ext_pll_pll_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                  // ext_pll_pll_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> ext_pll_pll_slave_agent:rdata_fifo_sink_error
	...
	wire          hex_pio_s1_agent_rdata_fifo_src_valid;                                              // hex_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_015:in_0_valid
	wire   [33:0] hex_pio_s1_agent_rdata_fifo_src_data;                                               // hex_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_015:in_0_data
	wire          hex_pio_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_015:in_0_ready -> hex_pio_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_015_out_0_valid;                                                  // avalon_st_adapter_015:out_0_valid -> hex_pio_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_015_out_0_data;                                                   // avalon_st_adapter_015:out_0_data -> hex_pio_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_015_out_0_ready;                                                  // hex_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_015:out_0_ready
	wire    [0:0] avalon_st_adapter_015_out_0_error;                                                  // avalon_st_adapter_015:out_0_error -> hex_pio_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) ext_pll_pll_slave_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (ext_pll_pll_slave_agent_m0_address),             // avalon_universal_slave_0.address
		.uav_burstcount         (ext_pll_pll_slave_agent_m0_burstcount),          //                         .burstcount
		.uav_read               (ext_pll_pll_slave_agent_m0_read),                //                         .read
		.uav_write              (ext_pll_pll_slave_agent_m0_write),               //                         .write
		.uav_waitrequest        (ext_pll_pll_slave_agent_m0_waitrequest),         //                         .waitrequest
		.uav_readdatavalid      (ext_pll_pll_slave_agent_m0_readdatavalid),       //                         .readdatavalid
		.uav_byteenable         (ext_pll_pll_slave_agent_m0_byteenable),          //                         .byteenable
		.uav_readdata           (ext_pll_pll_slave_agent_m0_readdata),            //                         .readdata
		.uav_writedata          (ext_pll_pll_slave_agent_m0_writedata),           //                         .writedata
		.uav_lock               (ext_pll_pll_slave_agent_m0_lock),                //                         .lock
		.uav_debugaccess        (ext_pll_pll_slave_agent_m0_debugaccess),         //                         .debugaccess
		.av_address             (ext_pll_pll_slave_address),                      //      avalon_anti_slave_0.address
		.av_write               (ext_pll_pll_slave_write),                        //                         .write
		.av_read                (ext_pll_pll_slave_read),                         //                         .read
		.av_readdata            (ext_pll_pll_slave_readdata),                     //                         .readdata
		.av_writedata           (ext_pll_pll_slave_writedata),                    //                         .writedata
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
		.av_byteenable          (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) ext_pll_pll_slave_agent (
		.clk                     (clk_0_clk_clk),                                      //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),     //       clk_reset.reset
		.m0_address              (ext_pll_pll_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (ext_pll_pll_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (ext_pll_pll_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (ext_pll_pll_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (ext_pll_pll_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (ext_pll_pll_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (ext_pll_pll_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (ext_pll_pll_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (ext_pll_pll_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (ext_pll_pll_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (ext_pll_pll_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (ext_pll_pll_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (ext_pll_pll_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (ext_pll_pll_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (ext_pll_pll_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (ext_pll_pll_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (ext_pll_pll_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (ext_pll_pll_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (ext_pll_pll_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (ext_pll_pll_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (ext_pll_pll_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (ext_pll_pll_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (ext_pll_pll_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (ext_pll_pll_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (ext_pll_pll_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (ext_pll_pll_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),                  // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),                  //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),                   //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),                  //                .error
		.rdata_fifo_src_ready    (ext_pll_pll_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (ext_pll_pll_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (ext_pll_pll_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                              //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) ext_pll_pll_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                      //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (ext_pll_pll_slave_agent_rf_source_data),             //        in.data
		.in_valid          (ext_pll_pll_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (ext_pll_pll_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (ext_pll_pll_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (ext_pll_pll_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (ext_pll_pll_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (ext_pll_pll_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (ext_pll_pll_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (ext_pll_pll_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (ext_pll_pll_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                              // (terminated)
		.csr_read          (1'b0),                                               // (terminated)
		.csr_write         (1'b0),                                               // (terminated)
		.csr_readdata      (),                                                   // (terminated)
	...
	nios_mm_interconnect_0_router_002 router_006 (
		.sink_ready         (ext_pll_pll_slave_agent_rp_ready),               //      sink.ready
		.sink_valid         (ext_pll_pll_slave_agent_rp_valid),               //          .valid
		.sink_data          (ext_pll_pll_slave_agent_rp_data),                //          .data
		.sink_startofpacket (ext_pll_pll_slave_agent_rp_startofpacket),       //          .startofpacket
		.sink_endofpacket   (ext_pll_pll_slave_agent_rp_endofpacket),         //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (ext_pll_pll_slave_agent_rdata_fifo_src_data),    //     in_0.data
		.in_0_valid     (ext_pll_pll_slave_agent_rdata_fifo_src_valid),   //         .valid
		.in_0_ready     (ext_pll_pll_slave_agent_rdata_fifo_src_ready),   //         .ready
	...
	nios_mm_interconnect_0_avalon_st_adapter_007 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
